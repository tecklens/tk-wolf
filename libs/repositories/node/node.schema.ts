...
const nodeSchema = new Schema<NodeDBModel>(
  {
    ...
    selected: Schema.Types.Boolean,
    dragging: Schema.Types.Boolean,
    draggable: Schema.Types.Boolean,
    selectable: Schema.Types.Boolean,
    connectable: Schema.Types.Boolean,
    resizing: Schema.Types.Boolean,
    deletable: Schema.Types.Boolean,
    dragHandle: Schema.Types.String,
