...
export class SendgridEmailProvider implements IEmailProvider {
  ...
  private createMailData(options: IEmailOptions) {
    ...
    const mailData: Partial<MailDataRequired> = {
      ...
      customArgs: {
        id: options.id,
        wolfTransactionId: options.notificationDetails?.transactionId,
        wolfMessageId: options.id,
        wolfWorkflowIdentifier: options.notificationDetails?.workflowIdentifier,
        wolfSubscriberId: options.notificationDetails?.subscriberId,
        ...options.customData,
      },
